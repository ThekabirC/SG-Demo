  ...
  return (
    <div className="config-card bg-white rounded-xl shadow-card p-5 h-[calc(100vh-92px)]">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <button className="flex items-center gap-2 text-purple-500 font-medium text-sm hover:text-purple-700 transition-colors">
          <Sparkles size={16} />
          Regenerate
        </button>
      </div>
      ...
      <div>
        {/* Column Headers */}
        <div className="flex items-center gap-4 py-2 text-xs text-gray-400 font-medium border-b border-gray-200">
          <div className="w-[80px]"></div>
          <div className="w-[100px]">Release Time</div>
          <div className="flex-1 min-w-[150px]">Strategy</div>
          <div className="w-[90px] text-center">Units</div>
          <div className="w-[100px] text-center">Rate ₹/kwh</div>
        </div>
        ...
        {gameplan.map((row) => (
          ...
          >
            {/* Timeslot */}
            <div className="w-[80px] text-sm text-gray-600">{row.timeslot}</div>
